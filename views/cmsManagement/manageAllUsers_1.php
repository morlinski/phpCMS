...
<?php
 ...
 ?>
    <script>
        $(document).ready(function(){ alert('jQuery!--from manageAllUsers_1.php'); });
        ...
        <table>
            ...
            <?php foreach($users as $user) :?>
                <tr>
                    ...
                    <td><p name="urole" style='text-align:center;'><?php echo $user[1]; ?></p></td>
                    <td style='display:none;'><input name="urole" type="text" placeholder="" maxlength="1" value="<?php echo $user[1]; ?>"/></td>
                    ...
                    <td style='display:none;'><button onclick="removeThisUser(this)">X</button></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
